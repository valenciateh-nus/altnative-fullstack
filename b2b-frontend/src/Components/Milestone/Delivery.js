...
export default function Delivery({deliveryId, handleRefresh}) {
  ...
  function handleMakeChanges() {
    ...
    return (delivery && !isLoading && <Box sx={{mb:2, mr:1}}>
        ...
        {currUser.sub === delivery.senderUsername ? <>
        <DeliveryInfoCard delivery={delivery} handleRefresh={handleRefresh}/>
