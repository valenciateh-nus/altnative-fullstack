...
export default function ConfirmationDialog({open, handleClose, handleCancel, handleConfirm, header = 'Confirm action?', dialogText = 'Are you sure you want to proceed?', confirmText = 'Confirm', showConfirm = true}) {
    return (
        <Dialog
            open={open}
            onClose={handleClose}
        ...
        >
            <Box sx={{backgroundColor : 'primary.light', display:'flex', flexDirection:'row', maxWidth: '450px'}}>
                ...
                <Box>
                  ...
                  <DialogActions sx={{marginBottom:'16px'}}>
                     ...
                     {showConfirm && <CustomButton variant='contained' color="secondary" onClick={handleConfirm} autoFocus>
                          {confirmText}
                      </CustomButton>}
                  </DialogActions>
                </Box>
