import { Button, Dialog, DialogActions, DialogTitle, Grid, SvgIcon, TextField, Typography } from '@mui/material';
import React from 'react';
import { useNavigate } from 'react-router';
import { ArrowLeft as ArrowIcon, DollarSign as DollarIcon, Plus as PlusIcon, Divide, Box } from 'react-feather';
        ...
        <Box sx={{ backgroundColor: 'primary.main', display: 'flex', flexDirection: 'row', maxWidth: '450px' }}>
          ...
          <Box>
            <DialogTitle id="final-rejection" sx={{ paddingLeft: 0, paddingRight: 0 }}>
              Confirm Widthdraw Amount of SGD{amount}?
            </DialogTitle>
