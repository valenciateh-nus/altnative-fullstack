...
import { MARKET_VIEW, REFASHIONEE_VIEW, REFASHIONER_VIEW, SWAP_VIEW } from "../constants.js";
...
export const toggleView = (view) => (dispatch) => {
    if(view === REFASHIONEE_VIEW || view === REFASHIONER_VIEW || view === MARKET_VIEW || view === SWAP_VIEW) {
