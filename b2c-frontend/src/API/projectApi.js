...
export const getAllRequestByCategoryKeyword = (cId, keyword) => API.get(`/api/v1/projectRequests/search/?cIds=${cId}&keyword=${keyword}`);

export const getAllRequestByKeyword = (keyword) => API.get(`/api/v1/projectRequests/search/?keyword=${keyword}`);

export const getAllFilteredRequests = (business) => API.get(`/api/v1/projectRequests/search/?isBusiness=${business}`);

export const getAllFilteredRequestsByKeyword = (business, keyword) => API.get(`/api/v1/projectRequests/search/?isBusiness=${business}&keyword=${keyword}`);
