...
export const getBusinesses = () => API.get(`/api/v1/users/roles/USER_BUSINESS`);

export const createBankAccountDetails = (formData) => API.post(`/api/v1/bankAccountDetails/createBankAccountDetails`, formData);

export const deleteBankAccountDetails = (id) => API.delete(`/api/v1/bankAccountDetails/deleteBankAccountDetails/${id}`);

export const getAllUsers = (role) => API.get(`/api/v1/users/roles/${role}`);

export const getSearchedRefashioners = (keyword) => API.get(`/api/v1/users/search?roles=USER_REFASHIONER&keyword=${keyword}`);

export const getSearchedBusinesses = (keyword) => API.get(`/api/v1/users/search?roles=USER_BUSINESS&keyword=${keyword}`);

export const getSales = () => API.get(`/api/v1/sales`);

export const getCompletedProjects = (id) => API.get(`/api/v1/refashioner/${id}/numberOfCompletedProjects`)