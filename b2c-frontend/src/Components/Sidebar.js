...
import { drawerWidth, MARKET_VIEW, REFASHIONEE_VIEW, REFASHIONER_VIEW, SWAP_VIEW } from '../constants';
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        {selectView === REFASHIONER_VIEW && <>
          ...
          <ListItemButton key={"upload"}
            selected={selectedTab === "createListing"}
            onClick={() => handleListItemClick('createListing')}
          >
              <ListItemIcon>
                <AddCircleOutlineOutlinedIcon/>
              </ListItemIcon>
        ...
        {selectView === SWAP_VIEW && <>
          <StyledList>
            <ListItemButton key={"home"}
            selected={selectedTab === "swap"}
            onClick={() => handleListItemClick('swap')}
            >
                <ListItemIcon>
                  <HomeOutlinedIcon/>
                </ListItemIcon>
            ...
            <ListItemButton key={"order"}
              selected={selectedTab === "swap/order"}
              onClick={() => handleListItemClick('swap/order')}
            >
                <ListItemIcon>
                  <CheckroomOutlinedIcon/>
                </ListItemIcon>
            ...
            <ListItemButton key={"upload"}
              selected={selectedTab === "swap/create"}
              onClick={() => handleListItemClick('swap/create')}
            >
                <ListItemIcon>
                  <AddCircleOutlineOutlinedIcon/>
                </ListItemIcon>
