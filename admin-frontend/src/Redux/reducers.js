import { AUTH, LOGOUT, ERROR, OPEN_IMAGE_MODAL, CLOSE_IMAGE_MODAL, SET_IMAGE_INDEX, SET_USER_PROFILE, TOGGLE_BOTTOM_NAV_BAR, TOGGLE_VIEW, FEEDBACK, JNT_AUTH, GET_CHAT_NOTIFICATIONS, NOTI} from "./actionTypes";
...
export default function reducers(state = INITAL_STATE, {type, data}) {
    switch(type) {
        ...
        case LOGOUT:
            return {authData : null, token : null, refresh_token : null, error : null};
        case ERROR:
