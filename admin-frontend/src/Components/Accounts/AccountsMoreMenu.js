...
export default function AccountsMoreMenu({selected = [], handleRefresh}) {
    ...
    const handleDelete = async () => {
        setLoadingMsg('Suspending users...')
        setIsLoading(true);
        let responses = []
    ...
    const handleReactivate = async () => {
        setLoadingMsg('Reactivating users...')
        setIsLoading(true);
        let responses = []
    ...
    return (
        ...
        />
        <LoadingModal open = {isLoading} text={loadingMsg}/>
