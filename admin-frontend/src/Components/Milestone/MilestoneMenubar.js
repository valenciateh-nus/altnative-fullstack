...
export default function MilestoneMenubar({isRefashionerPOV, orderId, handleRefresh,createMilestone, milestoneTypes = []}) {
    ...
    async function handleCreateDelivery(origin, deliveryDate) {
        let formData = {
            origin : origin,
            destination : "",
