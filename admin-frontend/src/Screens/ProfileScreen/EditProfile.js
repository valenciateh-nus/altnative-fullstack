...
export default function EditProfile() {
    ...
    const [userProfile, setUserProfile] = React.useState(dummyProfile);
                ...
                >
                    {userProfile.avatar ? (
                        <label htmlFor='profile-photo-upload'>
                            ...
                            />
                            <Avatar sx={{ height: '125px', width: '125px', cursor: 'pointer' }} src={userProfile.avatar instanceof File ? URL.createObjectURL(userProfile.avatar) : userProfile.avatar.url} alt="profile" />
                        </label>
                        ...
                        <label htmlFor='profile-photo-upload'>
                            <input
                                ...
                                onChange={onFileChange}
                            />
                            <AccountCircleIcon color='secondary' style={{ fontSize: 100, cursor : 'pointer' }} />
                        </label>
                    )}
                </Box>
